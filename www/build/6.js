...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__trash__ = __webpack_require__(638);
...
var TrashPageModule = (function () {
    ...
    TrashPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__trash__["a" /* TrashPage */]),
            ],
        })
    ], TrashPageModule);
...
var TrashPage = (function () {
    function TrashPage(navCtrl, shopping, toast, actionSheetCtrl) {
    ...
    //more options
    TrashPage.prototype.moreOptions = function (item) {
        var _this = this;
                ...
                },
                {
                    ...
                    handler: function () {
                        ...
                        _this.shopping.editItem(item).then(function () {
                            ...
                            _this.toast.show(item.title + " re-stored !");
