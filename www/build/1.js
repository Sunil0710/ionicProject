...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__calendar__ = __webpack_require__(631);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic2_calendar__ = __webpack_require__(283);
...
;(function (global, factory) {
    true ? factory(__webpack_require__(501)) :
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(501);
...
var CalendarPage = (function () {
    function CalendarPage(navCtrl, navParams, shopping, alertCtrl) {
        var _this = this;
        ...
        var events = [];
        this.shoppingList$.subscribe(function (data) {
            console.log(data);
    ...
    //show the searchbar 
    CalendarPage.prototype.showSearch = function () {
        console.log('Show Search Bar');
    };
    //add items to the calendar
    CalendarPage.prototype.addItem = function () {
        console.log('Add items to the calendar and to FBDB');
    };
    ...
    CalendarPage.prototype.onCurrentDateChanged = function (date) {
        // console.log('Selected Date: ' + date.toDateString());
        // console.log('Current Date: ' + this.calendar.currentDate.toDateString());
    ...
    CalendarPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-calendar',template:/*ion-inline-start:"/Users/wealthphasedev2/Desktop/ionicApps/notesApp/src/pages/calendar/calendar.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <button ion-button menuToggle>\n      <ion-icon ios="ios-menu" md="md-menu" name="menu"></ion-icon>\n    </button>\n    <ion-title> {{ viewTitle }} </ion-title>\n    <!-- <ion-title> My Calendar </ion-title> -->\n\n    <ion-buttons end>\n      <button ion-button (click)="showSearch()">\n        <ion-icon id="searchBtn" ios="ios-search-outline" md="md-search"></ion-icon>\n      </button>\n      <button ion-button (click)="addItem()">\n        <ion-icon id="addItemBtn" ios="ios-add" md="md-add"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n  <ion-toolbar no-border-top>\n      <ion-searchbar placeholder="Filter Items" showCancelButton color="danger" (ionInput)="filterItems($event)"></ion-searchbar>\n  </ion-toolbar>\n\n</ion-header>\n\n\n<ion-content class="calBg">\n  <!-- <ion-grid>\n    <ion-row justify-content-between>\n      <ion-col col-auto>\n        <button ion-button clear icon-only>\n          <ion-icon ios="ios-arrow-dropleft" md="md-arrow-dropleft"></ion-icon>\n        </button>\n      </ion-col>\n      <ion-col col-auto>\n        <button ion-button clear icon-only>{{ viewTitle }}</button>\n      </ion-col>\n      <ion-col col-auto>\n        <button ion-button clear icon-only>\n          <ion-icon ios="ios-arrow-dropright" md="md-arrow-dropright"></ion-icon>\n        </button>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n          <ion-col col-auto>\n              <ion-buttons>\n                  <button ion-button clear [disabled]="isToday" (click)="today()">Today</button>\n                  <button ion-button clear (click)="changeMode(\'day\')">Day</button>   \n                  <button ion-button clear (click)="changeMode(\'week\')">Week</button>\n                  <button ion-button clear (click)="changeMode(\'month\')">Month</button> \n              </ion-buttons>\n          </ion-col>\n        </ion-row>\n  </ion-grid> -->\n\n  <calendar [eventSource]="eventSource" \n            [calendarMode]="calendar.mode" \n            [currentDate]="calendar.currentDate" \n            (onCurrentDateChanged)="onCurrentDateChanged($event)"\n            (onEventSelected)="onEventSelected($event)" \n            (onTitleChanged)="onViewTitleChanged($event)" \n            (onTimeSelected)="onTimeSelected($event)"\n            step="30"\n            formatDayHeader = "E">\n  </calendar>\n\n  <!-- <ion-list>\n    <ion-item *ngFor="let item of (shoppingList$ | async)">\n        {{item.title}}\n    </ion-item>\n  </ion-list> -->\n</ion-content>'/*ion-inline-end:"/Users/wealthphasedev2/Desktop/ionicApps/notesApp/src/pages/calendar/calendar.html"*/,
        }),
